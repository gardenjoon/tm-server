...
@Index("food_ingr_pkey", ["sqno"], { unique: true })
@Entity("food_ingr", { schema: "public" })
export class FoodIngr {
  @Column("integer", { primary: true, name: "sqno" })
  sqno: number;

  @Column("character varying", { name: "food_id", nullable: true, length: 10 })
  foodId: string | null;

  @Column("character varying", { name: "src", nullable: true, length: 7 })
  src: string | null;
